...
public final class SlidingWindowCounter<T> implements Serializable {
    ...
    private SlotBasedSum<T> objCounter;
    ...
    public SlidingWindowCounter(int windowLengthInSlots) {
        ...
        this.objCounter = new SlotBasedSum<T>(this.windowLengthInSlots);

        this.headSlot = 0;
        this.tailSlot = slotAfter(headSlot);
    }

    public void add(T obj, long value) {
        objCounter.add(obj, headSlot, value);
    }
    ...
    public Map<T, Long> getCountsThenAdvanceWindow() {
        Map<T, Long> counts = objCounter.getSums();
